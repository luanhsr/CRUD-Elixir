defmodule RegUserWeb.UserControllerTest do
  ...
  @create_attrs %{name: "some name", description: "some description", email: "some email"}
  @update_attrs %{name: "some updated name", description: "some updated description", email: "some updated email"}
  @invalid_attrs %{name: nil, description: nil, email: nil}
